...
import static com.htc.wallet.skrsdk.backup.constants.SocialKeyRecoveryRequestConstants.TYPE_BACKUP_SOURCE;
import static com.htc.wallet.skrsdk.backup.constants.SocialKeyRecoveryRequestConstants.TYPE_BACKUP_TARGET;
import static com.htc.wallet.skrsdk.backup.constants.SocialKeyRecoveryRequestConstants.TYPE_RESTORE_TARGET;
        ...
        switch (holder.getItemViewType()) {
            ...
            case TYPE_BACKUP_SOURCE:
                ...
                setUpHolderData(
                        holder,
                        String.format(
                                mContext.getString(R.string.social_restore_backup_requests),
            ...
            case TYPE_RESTORE_TARGET:
                ...
                setUpHolderData(
                        ...
                        String.format(
                                mContext.getString(
                                        R.string
                                                .social_restore_backup_recovery_support_request_from),
